          ...
          <Content>
            <section style={{ textAlign: 'center' }}>
              ...
              <section style={{ textAlign: 'left', border: '1px solid #a1adc3', borderRadius: '10px', marginLeft: '50px', marginRight: '50px', marginTop: '50px', padding: '25px', backgroundColor: '#b2bed4', boxShadow: '3px 3px 3px #373f4a' }}>
                ...
                <p>By tapping into <a href='https://openai.com/' target='blank' alt='OpenAI'>OpenAI</a>, we're able to provide secure, personalized access to one of their API Playgrounds that uses Artifical Intelligence to read and explain your code for you.</p>
